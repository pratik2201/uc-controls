...
const Resources:UserResource[] = [
    ...
    {   guid: "uc-controls:e88aa70c-55a2-452f-ba44-e28f2bca81ba:00000004",   project: "uc-controls",  source: "uc-controls\\src\\RecycleView.uc.scss",   type: "css",  encrypt:false,   content: "$i-LISTVIEW_BACK:transparent;&{width:100%;height:100%;box-sizing:border-box;position:relative;overflow:hidden;display:grid;grid-template-columns:auto max-content;grid-template-rows:max-content minmax(auto,100%) max-content;background-color:$i-LISTVIEW_BACK transparent --;}hscrollbar,vscrollbar{position:relative;display:block;width:11px;height:11px;}vscrollbar{height:100%;overflow-y:auto;position:absolute;right:0px;top:0px;bottom:0px;grid-column:2;grid-row:1 / span 3;}vscrollbar sizer,hscrollbar sizer{position:absolute;width:100%;height:100%;display:block;position:absolute;}scroll-text[role=\"begin\"]{grid-column:1;grid-row:2;margin-left:5px;}pagecntnr{grid-column:1;grid-row:3;}scroll-text[role=\"end\"]{grid-column:1;grid-row:3;text-align:right;margin-right:5px;}scrollbar{position:relative;height:100%;top:0px !important;left:0px !important;right:0px !important;bottom:0px !important;border-radius:0px;}pagecntnr{overflow:hidden;position:relative;width:100%;height:100%;max-width:100%;max-height:100%;display:inline-grid;box-sizing:border-box;}tbl{width:100%;height:max-content;box-sizing:border-box;display:inline-block;grid-auto-rows:max-content;align-self:flex-start;}"  }, 
