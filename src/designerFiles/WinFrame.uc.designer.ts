...
export class WinFrame$Designer extends Usercontrol {    
    ...
    initializecomponent?(args: IUcOptions, form: WinFrame){
        ...
        args.guid = "uc-controls:e88aa70c-55a2-452f-ba44-e28f2bca81ba:00000008";
        args.htmlContent = ResourceManage.getContent("uc-controls:e88aa70c-55a2-452f-ba44-e28f2bca81ba:00000007");
        args.cssContent = ResourceManage.getContent("uc-controls:e88aa70c-55a2-452f-ba44-e28f2bca81ba:00000008");
